import { Users, MapPin, Beaker, Code, Briefcase } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg">
            Kolaborasi multidisiplin untuk solusi pesisir berkelanjutan
          </p>
        </div>
          ...
          {team.map((member, idx) => (
            ...
            >
              <div className="flex justify-center mb-6">
                <div className={`w-24 h-24 bg-gradient-to-br ${member.color} rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}>
                  {member.icon}
                </div>
              </div>
